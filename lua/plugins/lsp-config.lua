return
{
    ...
    },
    {
        ...
        config = function()
            ...
            -- set vim motion for <Space> + c + h to show code documentation about the code the cursor is currently over if avaible
            ...
            -- set a vim motion for <Space> + c + <Shift>D to go where the code/object was declared in the project (class file)
