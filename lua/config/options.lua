...
vim.opt.shiftwidth = 4 -- number of spaces insert for each indentation level
...
vim.opt.splitright = true -- force vertical splits right of current windows
...
vim.opt.writebackup = false -- prevent editting of files being edited elsewhere
