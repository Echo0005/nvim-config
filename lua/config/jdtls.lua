local function get_jdtls()
    ...
    -- Obtain the path to the jar wich runs the language server
...
local function get_bundles()
    ...
    -- Obatain the full path to the directory where Mason has downloaded the Java Debug Adapter binaries
    ...
    -- Find the Java Test packege in the Mason Registry
...
local function java_keymaps()
    ...
    -- Allow yourself to run JdtComple as a Vim command
...
local function setup_jdtls()
    ...
    -- Modify one property called resolveAdditionalTextEditsSupport and set in to true
    ...
    -- Configure setting in the JDTLS server
    local settings = {
        java = {
    ...
    local on_attach = function(_, bufnr)
        ...
        -- Unfortunatelt I have not found an elegant way to ensure this works 100%
        ...
        -- Code lens enables features such as code reference counts, implemetation counts, and more.
